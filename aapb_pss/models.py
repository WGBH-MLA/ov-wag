...
class AAPBPrimarySourceSet(Page):
    ...
    subjects = RichTextField(blank=True)

    pdf_link = models.URLField(
        blank=True, help_text="Direct URL to the downloadable teaching-tips PDF."
    )
...
class AAPBPssRelatedExhibit(Orderable):
    page = ParentalKey(
        "aapb_pss.AAPBPrimarySourceSet", related_name="other_exhibits", null=True
    )
...
class AAPBPssRelatedCollection(Orderable):
    page = ParentalKey(
        "aapb_pss.AAPBPrimarySourceSet", related_name="other_collections", null=True
    )
...
class AAPBPssRelatedPrimarySourceSet(Orderable):
    page = ParentalKey(
        "aapb_pss.AAPBPrimarySourceSet", related_name="other_pss", null=True
    )
